...
typedef NS_ENUM(NSUInteger, FPPlayerLoadState) {
    FPPlayerLoadStateUnknown        = 0,
    FPPlayerLoadStatePrepare        = 1, /**< 准备阶段 */
    FPPlayerLoadStatePlayable       = 2, /**< 随时可播放 */
    FPPlayerLoadStatePlayThroughOK  = 3, // Playback will be automatically started.
    FPPlayerLoadStateStalled        = 4, /**< 开始播放时候,网络比较差等原因导致播放器buffer不够用,会进入这个状态,此时视频会自动暂停 */
    FPPlayerLoadStateError        = 5
};
